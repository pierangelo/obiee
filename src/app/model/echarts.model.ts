      ...
      series: [
        {
          ...
          tooltip: {
            formatter: function(d) {
              return (
                'Uomini <br/><span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#01579b;"></span>' +
        ...
        },
        {
          ...
          tooltip: {
            formatter: function(d) {
              return (
                'Donne <br/><span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#9b0157;"></span>' +
                d.value.toLocaleString("it-IT")
              );
            }
          },
      ...
      tooltip: {
        ...
        formatter: function(params, ticket, callback) {
          ...
          for (var i = 0; i < params.length; i++) {
            ...
            tooltip +=
              '<span style="text-align:center;display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:' +
              color +
              '"></span>';
            tooltip +=
              params[i].seriesName +
          ...
          data: [
            {
              ...
              itemStyle: {
                normal: {
                  color: "#00305A" //'#0b3766'//'rgba(105,204,230)'
                }
              }
            },
            {},
